...
class FolderDataset:
    def __init__(self, root_path: pathlib.Path, noise_maker: Union[NoiseMaker, dict] = None, color_bit=8, augments=None, valid_suffix=[".npy"]):
    ...
    def getitem(self, index: int, enable_aug: bool = False, enable_noise: bool = False):
        ...
        gt = (gt / 2**self.color_bit) if self.color_bit != 0 else gt
